...
suite "Sum of Multiples":
  ...
  # This is the test case I have added to catch an edge case in my implementation.
  test "It does not matter where the factor 0 is placed in the factors array":
    check sum(4, @[0, 3]) == 3
